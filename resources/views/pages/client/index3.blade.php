...
<!-- Mirrored from satumomen.com/preview/almond-flowers by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 06:13:10 GMT -->
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
        <title>The Wedding Of Abu &amp; Faizah</title>
    ...
    <meta property="og:url" content="almond-flowers.html">
    <meta property="og:title" content="The Wedding Of Abu &amp; Faizah">
    ...
    <meta property="og:image" content="client/theme2/images/invitation/cover-32971653468239.jpg">

    <!-- css -->
    <link rel="stylesheet" href="client/theme2/cdn.jsdelivr.net/npm/%40splidejs/splide%40latest/dist/css/splide.min.css">
    <link rel="stylesheet" href="client/theme2/cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css" />
    <link href="client/theme2/themes/bootstrap.min.css" rel="stylesheet">
    ...
    :root {
      ...
      --font-latin: 'Sail', cursive;
      --menu-bg: #ffffff;
      --menu-inactive: #b8b0a3;
      --menu-active: #a66335;
      --btn-color: #ffffff;
    }
    </style>
...
<body>
        ...
        <div id="loader" class="loader-wrapper"><span class="loader"><span class="loader-inner"></span></span></div>
            ...
            <source src="https://satumomen.id/musics/atta-halilintar-and-aurel-hermansyah-hari-bahagia.mp3">
            </audio>
                    <!-- end music -->
                        <!-- invitation -->
        <div id="satuMomen" class="splide not-open  " data-guest="Nama Tamu">
                        <div class="splide__track invitation__track">
                <ul class="splide__list invitation__list">
                                        <li class="splide__slide invitation__slide">
                        <div class="container-mobile" style="background-image: url(https://satumomen.com/themes/almond-flowers/bg.webp); ;">
                            
  <div class="frame">
    <img class="frame-tl animate__animated animate__fadeInLeft animate__slower" src="https://satumomen.com/themes/almond-flowers/frame-tl.webp"
      alt="frame" style="width: 70%;">
    <img class="frame-tr animate__animated animate__fadeInDown animate__slower" src="https://satumomen.com/themes/almond-flowers/frame-tr.webp"
      alt="frame">
    <img class="frame-br animate__animated animate__fadeInUp animate__slower" src="https://satumomen.com/themes/almond-flowers/frame-br.webp"
      alt="frame">
  </div>
...
">
    ...
    <div class="editable mb-2 animate__animated animate__fadeInDown animate__slower">The Wedding Of</div><div class="editable font-accent color-accent h2 mb-2 animate__animated animate__fadeInDown animate__slow">Franky<br>&amp;<br>Katie</div>
<div class="editable mb-3 animate__animated animate__fadeInDown">22 - FEB - 2022</div>
</div>
    
    
    <div class="text-center">
        
        <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower">Kepada Yth<br>Bapak/Ibu/Saudara/i</div>
<div id="guestNameSlot" class="editable color-accent h5 font-weight-bold mb-4 animate__animated animate__fadeInUp animate__slower">Tamu Undangan</div>

<button type="button" class="btn-open-invitation btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow">Open Invitation</button>
  ...
  <div class="frame">
    ...
    <div style="width: 100%;">
      <div style="height: 230px;width: 100%;margin: auto;overflow: hidden;margin-bottom: 20px;/* border: 4px solid var(--inv-border); */border-radius: 10px;" class="image-editable animate__animated animate__fadeInDown animate__slower">
        <img class="mb-4" src="client/theme2/images/galleries/3106-gallery-1643912585.png" style="width: 100%;height: 100%;object-fit: cover;">
      </div>
      <div class="text-center animate__animated animate__fadeInUp animate__slower">
        <div class="editable quotes mb-3">Dan di antara tanda-tanda (kebesaran)-Nya ialah Dia menciptakan pasangan-pasangan untukmu dari jenismu sendiri, agar kamu cenderung dan merasa tenteram kepadanya, dan Dia menjadikan di antaramu rasa kasih dan sayang. Sungguh, pada yang demikian itu benar-benar terdapat tanda-tanda (kebesaran Allah) bagi kaum yang berpikir.</div>
        <div class="editable font-italic">[ QS. Ar-Rum : 21 ]</div>
      </div>
    </div>
  </div>
                        </div>
...
">
        <div width="100%">
<div class="editable mb-3 text-center animate__animated animate__fadeInDown animate__slower" style="font-size: 14.4px;">Assalamualaikum wr wb<br>Tanpa mengurangi rasa hormat kami bermaksud mengundang Bapak/Ibu/Saudara/i pada acara resepsi pernikahan kami:</div>
...
gap: 20px;">
    ...
    align-items: center;
">
    <img src="client/theme2/images/galleries/3297-gallery-1653468382.jpg" style="width: 100%;height: 100%;object-fit: cover;border-radius: 100%;">
</div>
    ...
    align-items: center;
">
    <img src="client/theme2/images/galleries/3297-gallery-1653468365.jpg" style="width: 100%;height: 100%;object-fit: cover;border-radius: 100%;">
</div>
    ...
    <div class="text-center animate__animated animate__fadeInUp animate__slower mb-4">
        <div class="editable font-latin color-accent h4 mb-2">Akhmad Faisal</div>
        <div class="editable mb-2">Putra Pertama Bapak H. Amin<br>dan Ibu Hj. Salamah</div>
<a class="link btn btn-sm btn-primary rounded-pill" href="https://instagram.com/satumomen_com" target="_blank" style="font-family: sans-serif;">@satumomen_com</a>
    </div><div class="text-center animate__animated animate__fadeInUp animate__slower">
        <div class="editable font-latin color-accent h4 mb-2">Noor Hidayati</div>
        <div class="editable mb-2">Putri Ke 2 Bapak Sulaiman Hakim<br>dan Ibu Widia Astuti</div>
<a class="link btn btn-sm btn-primary rounded-pill" href="https://instagram.com/satumomen_com" target="_blank" style="font-family: sans-serif;">@satumomen_com</a>
    </div>
    </div></div>
                        </div>
...
</div><div class="text-center mb-4 animate__animated animate__fadeInRight animate__slower">
    <div class="editable font-latin color-accent h4 mb-2" style="font-size: 28.8px;">Resepsi 1</div>
    <div class="editable ">Minggu, 2 Januari 2022</div>
    <div class="editable ">Pukul 18:00 Wita</div>
    <div class="editable ">Satu Momen<br>Jl. Wildan Sari 1 No. 11 Banjarmasin Barat</div>
</div>
  ...
  <div class="frame">
    ...
    <div style="width: 100%;">
      <div class="animate__animated animate__fadeInRight animate__slower">
        <div class="image-editable" style="width: 248px; margin: auto; overflow: hidden; margin-bottom: 20px; border: 4px solid var(--inv-base);">
          <img src="client/theme2/images/galleries/3297-gallery-1653468347.jpg" style="width: 100%;height: 100%;object-fit: cover;">
        </div>
      </div>
      <div class="text-center mb-4 animate__animated animate__fadeInLeft animate__slower">
        <div class="editable font-latin color-accent h4 mb-2" style="font-size: 28.8px;">Resepsi 2</div>
        <div class="editable ">Minggu, 2 Januari 2022</div>
        <div class="editable ">Sesi 1 Pukul 08.00 WITA<br>Sesi 3 Pukul 10.00 WITA<br>Sesi 4 Pukul 11.00 WITA</div>
        <div class="editable ">Alamat</div>
      </div>
      <div class="countdown-wrapper d-flex flex-column animate__animated animate__fadeInUp animate__slower" data-datetime="2022-01-31T19:11">
        <div class="countdown text-center">
          <div class="countdown-item day">
            <div class="number">00</div>
            <div class="text editable">Hari</div>
        ...
        <button class="btn-countdown btn btn-sm btn-pilled btn-accent mt-2" style="">Atur Tanggal</button>
      </div>
    </div>
  </div>
                        </div>
...
<div class="text-center animate__animated animate__fadeInUp animate__slow">
        ...
        <div class="editable mb-3">Satu Momen<br>RT.001/RW.001, Telaga Biru, Banjarmasin City, South Kalimantan, Indonesia</div>
    <a href="https://www.google.com/maps/search/?q=-3.3265096968337646,114.5743546576721" class="btn-maps-link btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" target="_blank">Petunjuk Ke Lokasi</a>
    </div>
      ...
      <div class="image-editable d-flex flex-wrap">
        <div style="width: 33.333%;overflow: hidden;padding: 4px;" class="animate__animated animate__zoomIn animate__slower">
          <div class="light" style=" overflow: hidden; width: 100%; height: 100px; ">
            <img src="client/theme2/images/galleries/3297-gallery-1653468347.jpg" style="width: 100%;height: 100%;object-fit: cover;" class="lightbox">
          </div>
        </div>
        <div style="width: 33.333%;overflow: hidden;padding: 4px;" class="animate__animated animate__zoomIn animate__slower">
        ...
        <div style="width: 50%;overflow: hidden;padding: 4px;" class="animate__animated animate__zoomIn animate__slower">
          <div class="" style=" overflow: hidden; width: 100%; height: 100px; ">
            <img src="client/theme2/images/galleries/3297-gallery-1653468347.jpg" style="width: 100%;height: 100%;object-fit: cover;" class="lightbox">
          </div>
        </div>
        ...
        <div style="width: 33.333%;overflow: hidden;padding: 4px;" class="animate__animated animate__zoomIn animate__slower">
          <div class="" style=" overflow: hidden;  width: 100%; height: 100px;  object-fit: cover; ">
            <img src="client/theme2/images/galleries/3297-gallery-1653468347.jpg" style="width: 100%;height: 100%;object-fit: cover;" class="lightbox">
          </div>
        </div>
      </div>
...
<div class="image-editable animate__animated animate__fadeInLeft animate__slower m-2" style="
    height: 90px;
    width: 90px;
    border-radius: 10px;
    overflow: hidden;
">
    <img src="client/theme2/upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Instagram_icon.png/2048px-Instagram_icon.png" style="width: 100%;height: 100%;object-fit: cover;">
</div>
    
</div><a href="https://satumomen.com/" target="_blank" class="link btn btn-primary rounded-pill my-3 animate__animated animate__fadeInUp animate__slow">Join Live Streaming</a><div class="editable animate__animated animate__fadeInUp animate__slower">Instagram : @satumomen_com<br>Zoom Meeting ID : 123456789<br>Password : Rahasia</div></div></div>
                        </div>
                    </li>
                                        <li class="splide__slide invitation__slide">
                        <div class="container-mobile" style="background-image: url(https://satumomen.com/themes/almond-flowers/bg.webp); ;">
  ...
  <div class="frame">
    ...
    <img class="frame-br animate__animated animate__fadeInUp animate__slower" src="https://satumomen.com/themes/almond-flowers/frame-br.webp"
      alt="frame">
                            ...
                            <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
    <div style="width: 100%;" class="text-center">
      <div class="editable font-latin color-accent h4 mb-3 animate__animated animate__fadeInDown animate__slower">
        Rundown Acara</div>
      <div class="animate__animated animate__fadeInUp animate__slower">
        <div style="font-size: 12px;" class="mb-2">
          <div class="editable font-weight-bold">09:00 - Persiapan</div>
          <div class="editable">Pengantin bersiap memasuki Ballroom.</div>
        </div>
        <div style="font-size: 12px; " class="mb-2">
          <div class="editable font-weight-bold">09:30 - Memasuki Ruang Acara</div>
          <div class="editable">Pengantin memasuki Ballroom menuju pelaminan.</div>
        </div>
        <div style="font-size: 12px;" class="mb-2">
          <div class="editable font-weight-bold">09:45 - Makan &amp; Foto Bersama</div>
          <div class="editable">Para tamu undangan dipersilahkan makan dan dapat berfoto bersama di pelaminan.</div>
        </div>
        <div style="font-size: 12px;" class="mb-2">
          <div class="editable font-weight-bold">11:00 - Beauty Shoot</div>
          <div class="editable">Sesi foto pengantin di bimbing oleh Fotografer.</div>
        </div>
        <div style="font-size: 12px;" class="mb-2">
          <div class="editable font-weight-bold">12:00 - Istirahat Ganti Kostum</div>
          <div class="editable">Pengantin dipersilahkan untuk ganti kostum</div>
        </div>
        <div style="font-size: 12px;" class="mb-2">
          <div class="editable font-weight-bold">15:00 - Beauty Shoot</div>
          <div class="editable">Sesi foto pengantin di bimbing oleh Fotografer.</div>
        </div>
      </div>
    </div>
  ...
  <div class="frame">
    ...
    <img class="frame-br animate__animated animate__fadeInUp animate__slower" src="https://satumomen.com/themes/almond-flowers/frame-br.webp"
      alt="frame">
                            ...
                            <div class="d-flex justify-content-center align-items-center" style="height: 100%; ">
    <div style="width: 100%;" class="text-center">
      <div class="font-latin color-accent h4 mb-2 editable animate__animated animate__fadeInDown animate__slower">Kirim Hadiah</div>
      <div class="editable mb-4 animate__animated animate__fadeInDown animate__slower">Doa Restu Anda merupakan karunia yang sangat berarti bagi kami. Namun jika Anda ingin memberi hadiah kami sediakan fitur berikut</div>
<div style="
    display: flex;
">
    <button type="button" class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="
    max-width: 150px;
    margin: auto;
">🎁 Hadiah</button>
    <button type="button" class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="
...
">
        <div style="height: 150px;width: 100%;max-width: 150px;margin: auto;overflow: hidden;margin-bottom: 20px;border-radius: 10px;" class="image-editable">
          <img class="mb-4 lightbox" src="client/theme2/images/galleries/3297-gallery-1653468407.jpg" style="width: 100%;height: 100%;object-fit: cover;">
        </div>
...
<div class="editable mb-4 text-center animate__animated animate__fadeInUp animate__slower">Hubungi Contact Person kami jika ada hal<br>yang ingin ditanyakan.</div>
    ...
    <div class="image-editable animate__animated animate__fadeInUp animate__slower" style="height: 100px; width: 100px; margin: auto; border-radius: 100%; overflow: hidden; margin-bottom: 10px;">
        <img src="client/theme2/images/galleries/3297-gallery-1653468382.jpg" style="width: 100%;height: 100%;object-fit: cover;">
      </div>
        <div class="editable font-latin color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower">Akhmad Faisal</div>
<a class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower" href="https://wa.me/6281250335095" target="_blank">WA 0812-2345-6789</a>
    </div>
    <div class="text-center animate__animated animate__fadeInUp animate__slower">
    <div class="image-editable animate__animated animate__fadeInUp animate__slower" style="height: 100px; width: 100px; margin: auto; border-radius: 100%; overflow: hidden; margin-bottom: 10px;">
        <img src="client/theme2/images/galleries/3297-gallery-1653468382.jpg" style="width: 100%;height: 100%;object-fit: cover;">
        ...
        <div class="editable font-latin color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower">Akhmad Faisal</div>
<a class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower" href="https://wa.me/6281250335095" target="_blank">WA 0812-3456-7890</a>
    </div></div></div>
                        </div>
                    </li>
                                        <li class="splide__slide invitation__slide">
  ...
  <div class="frame">
    ...
    <div class="editable font-latin color-accent h4 mb-4 animate__animated animate__fadeInDown animate__slower">Do'a Untuk Pengantin</div>
          ...
          <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower">Tekan tombol dibawah ini untuk mengirim ucapan dan konfirmasi kehadiran</div><button type="button" class="btn-rsvp btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" style="font-size: 14.4px;">Konfirmasi &amp; Kirim Ucapanmu</button><div class="editable mb-4 animate__animated animate__fadeInUp animate__slower">Batas akhir konfirmasi<br>30 April 2022</div>
        </div>
    </div>
  </div>
                        </div>
  ...
  <div class="frame">
    ...
    <img class="frame-br animate__animated animate__fadeInUp animate__slower" src="https://satumomen.com/themes/almond-flowers/frame-br.webp"
      alt="frame">
                            ...
                            <div class="watermark d-flex justify-content-center align-items-center" style="
    height: 100%;
">
    ...
    <div class="editable font-accent h4 color-accent animate__animated animate__fadeInDown animate__slow">Abu &amp; Faizah</div>
<div class="watermark-placeholder mt-5"></div>
            ...
            <div class="splide__track menu-track">
                <ul class="splide__list menu-list">
                        ...
                        <span>Live</span>
                                        ...
                                        <li class="splide__slide menu-item">
                        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity=".4" d="M16.34 2H7.67C4.28 2 2 4.38 2 7.92v8.17C2 19.62 4.28 22 7.67 22h8.67c3.39 0 5.66-2.38 5.66-5.91V7.92C22 4.38 19.73 2 16.34 2Z" fill="currentColor"/><path d="M15.573 15.814a.756.756 0 0 1-.384-.105l-3.926-2.342a.754.754 0 0 1-.365-.645V7.675a.75.75 0 0 1 1.5 0v4.621l3.56 2.123a.752.752 0 0 1-.385 1.395Z" fill="currentColor"/></svg>
                        <span>Rundown</span>
                    </li>
                                        <li class="splide__slide menu-item">
                        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity=".4" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83v10.33C3 20.26 4.77 22 7.81 22h8.381C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M8.08 6.65v.01a.78.78 0 0 0 0 1.56h2.989c.431 0 .781-.35.781-.791a.781.781 0 0 0-.781-.779H8.08Zm7.84 6.09H8.08a.78.78 0 0 1 0-1.561h7.84a.781.781 0 0 1 0 1.561Zm0 4.57H8.08c-.3.04-.59-.11-.75-.36a.795.795 0 0 1 .75-1.21h7.84c.399.04.7.38.7.79 0 .399-.301.74-.7.78Z" fill="currentColor"/></svg>
        ...
        <div class="modal fade" id="rsvpModal" tabindex="-1" role="dialog" aria-labelledby="rsvpModal"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="height:100%">
                    <!-- rsvp form -->
                                        <rsvp-component :invitation_id="3297" code="#" overlay="1">
                    </rsvp-component>
                                        <!-- rsvp form -->
        ...
        <!-- endRSVPModal -->
                <div id="waterMark" class="mt-5" style="display: none"></div>
            </main>
    <!-- illegal -->
                ...
                <div class="modal-body text-center justify-content-center align-items-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="https://apps.apple.com/id/app/google-chrome/id535886823" class="btn p-1" target="_BLANK">
                            <img src="client/theme2/images/btn_app_store.png" alt="AppStore" height="40px">
                        </a>
                        <a href="https://play.google.com/store/apps/details?id=com.android.chrome&amp;hl=in&amp;gl=US" class="btn p-1" target="_BLANK">
                            <img src="client/theme2/images/btn_play_store.png" alt="PlayStore" height="40px">
                        </a>
                    </div>
                </div>
    ...
    <!-- start script -->
    <script src="client/theme2/js/app86de.js?v=2022-08-01%2013:13:09"></script>
    <script src="client/theme2/cdn.jsdelivr.net/npm/%40splidejs/splide%40latest/dist/js/splide.min.js"></script>
        <script src="client/theme2/themes/themev286de.js?v=2022-08-01%2013:13:09"></script>
    <script>
...
<!-- Mirrored from satumomen.com/preview/almond-flowers by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 06:13:14 GMT -->
</html>