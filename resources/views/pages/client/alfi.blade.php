...
<!-- Mirrored from satumomen.com/preview/azureish-white by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 15:53:35 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="client/theme3/cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css" />
    <link href="client/theme3/themes/bootstrap.min.css" rel="stylesheet">
...
<div class="editable mb-3 animate__animated animate__fadeInDown">30 Agustus 2022</div>
  ...
  @if(!empty($list['tamu']))
    <div class="editable color-accent h5 font-weight-bold mb-4 animate__animated animate__fadeInUp animate__slower"><b>{{ ucfirst($list['tamu']) }}</b></div>
  @endif

<button type="button" class="btn-open-invitation btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow">Buka Undangan</button>
                                        ...
                                        <li class="splide__slide invitation__slide">
                        <div class="container-mobile" style="background-image: url(client/theme3/images/invitation/bg-section-26301643912704.jpg); background-size: cover;">
                              <div class="frame">
    <img class="frame-tr animate__animated animate__fadeInDown animate__slower"
      src="client/theme3/themes/azureish-white/frame-tr.png" alt="frame" style="width: 100%;">
    <img class="frame-bl animate__animated animate__fadeInUp animate__slower" src="client/theme3/themes/azureish-white/frame-bl.png"
    ...
    <div style="width: 100%;">
      <div style="height: 230px;width: 100%;margin: auto;overflow: hidden;margin-bottom: 20px;/* border: 4px solid var(--inv-border); */border-radius: 10px;" class="image-editable animate__animated animate__fadeInDown animate__slower">
        <img class="mb-4" src="client/theme3/images/galleries/3106-gallery-1643912585.png" style="width: 100%;height: 100%;object-fit: cover;">
      </div>
...
{{-- <div class="d-flex justify-content-center mb-3" style="gap: 20px;">
  <div class="image-editable animate__animated animate__fadeInLeft animate__slower" style="
    ...
    align-items: center;
  ">
    <img src="client/theme3/images/galleries/3106-gallery-1653467473.jpg" style="width: 100%;height: 100%;object-fit: cover;border-radius: 100%;">
  </div>
  <div class="image-editable animate__animated animate__fadeInRight animate__slower" style="
    ...
    align-items: center;
  ">
    <img src="client/theme3/images/galleries/3106-gallery-1653467479.jpg" style="width: 100%;height: 100%;object-fit: cover;border-radius: 100%;">
  </div>
</div> --}}
    
    <div class="text-center animate__animated animate__fadeInUp animate__slower mb-4">
      <div class="editable font-latin color-accent h4 mb-2">Muh. Alfisina M. R., S.Kom</div>
      <div class="editable mb-2">Putra Bpk. Ngadiyo<br>dan Ibu Siti Badrul Chayati / Atik</div>
    ...
    <div class="text-center animate__animated animate__fadeInUp animate__slower">
      <div class="editable font-latin color-accent h4 mb-2">Nida Azzulfa, S.Kep.Ns</div>
      <div class="editable mb-2">Putri Bpk. Sudarno dan Ibu Umi Lestari</div>
      {{-- <a class="link btn btn-sm btn-primary rounded-pill" href="https://instagram.com/satumomen_com" target="_blank" style="font-family: sans-serif;">@satumomen_com</a> --}}
    </div>
  </div>
</div>
...
<div style="width: 100%">
  ...
  <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
    <div style="width: 100%;">
      <div class="text-center mb-3 animate__animated animate__fadeInDown animate__slower">
        <div class="editable font-latin color-accent h4 mb-2" style="font-size: 28.8px;">Ngunduh Mantu</div>
        <div class="editable ">Minggu, 2 Maret 2022</div>
        <div class="editable ">Pukul 08.00 WITA sd Selesai</div>
      </div>
      <div class="countdown-wrapper mb-3 d-flex flex-column animate__animated animate__fadeInDown animate__slower" data-datetime="2022-03-06T09:00">
        <div class="countdown text-center">
          <div class="countdown-item day">
      ...
      <div style="width: 100%; margin: auto; border-radius: 10px; overflow: hidden; margin-bottom: 20px; padding-bottom: 50%; position: relative;" class="animate__animated animate__fadeInUp animate__slow">
        <iframe width="100%" height="100%" style="border:0;position: absolute;" loading="lazy" allowfullscreen="" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCpV55KNPo55TuxnDFd_dR3MD0luBrN1Gc&amp;zoom=17&amp;q=-3.3386173,114.6185226" class="maps-embed">
        </iframe>
      </div>
      ...
      <div class="text-center animate__animated animate__fadeInUp animate__slow">
        <div class="editable mb-3">BEST WESTERN KINDAI HOTEL<br>Jl. Ahmad Yani Km.4,5 No.437, Kecamatan Banjarmasin
          Timur</div>
        <a href="https://www.google.com/maps/place/?q=-3.3386173,114.6185226" class="btn-maps-link btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" target="_blank">Petunjuk Ke Lokasi</a>
      </div>
    </div>
  </div>
                        </div>
      ...
      <div class="image-editable d-flex flex-wrap">
        <div style="width: 33.333%;overflow: hidden;padding: 4px;" class="animate__animated animate__zoomIn animate__slower">
          <div class="light" style=" overflow: hidden; width: 100%; height: 100px; ">
            <img src="client/theme3/images/galleries/3106-gallery-1653467493.jpg" style="width: 100%;height: 100%;object-fit: cover;" class="lightbox">
          </div>
        </div>
        <div style="width: 33.333%;overflow: hidden;padding: 4px;" class="animate__animated animate__zoomIn animate__slower">
...
<div class="editable mb-0">Anda dapat mengirim kado ke:<br>Wonosari Rt. 01/13 Polokarto, Polokarto, Sukoharjo</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="image-editable animate__animated animate__fadeInLeft animate__slower m-2" style="
    ...
    overflow: hidden;
">
    <img src="client/theme3/upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Instagram_icon.png/2048px-Instagram_icon.png" style="width: 100%;height: 100%;object-fit: cover;">
</div>
      ...
      <div>
        <div class="animate__animated animate__fadeInRight animate__slower">
          <div class="image-editable" style="
              ...
              ">
            <img src="client/theme3/images/galleries/3106-gallery-1653467493.jpg" style="width: 100%; height: 100%; object-fit: cover">
          </div>
        </div>
        ...
        <div class="text-center">
          ...
          <button type="button" class="btn-rsvp btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow" style="font-size: 14.4px;">Kirim Ucapanmu Disini</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="editable mb-4 text-center animate__animated animate__fadeInUp animate__slower">Hubungi Contact Person kami jika ada hal<br>yang ingin ditanyakan.</div>
    ...
    <div class="image-editable animate__animated animate__fadeInUp animate__slower" style="height: 100px; width: 100px; margin: auto; border-radius: 100%; overflow: hidden; margin-bottom: 10px;">
        <img src="client/theme3/images/galleries/3106-gallery-1653467473.jpg" style="width: 100%;height: 100%;object-fit: cover;">
      </div>
...
">
    ...
    <div class="editable animate__animated animate__fadeInDown animate__slower">(Ridho Illahi Trans) - (Kepala BA Aisyiyah Wonosari)</div>
    <br><br><br>
    <div class="editable mb-2 animate__animated animate__fadeInDown animate__slower" style="font-size:9pt">Design by.</div>
    <center><a type="button" class="btn btn-light rounded-pill animate__animated animate__fadeInUp animate__slow" href="https://www.instagram.com/kilatphoto/" target="_blank" style="width: 25%;"><img src="client/theme3/images/logo-kilat-hitam.png" alt="frame" style="width: 100%;vertical-align: middle;"></a></center>
{{-- <div class="watermark-placeholder mt-5"></div> --}}
        ...
        <div class="modal fade" id="rsvpModal" tabindex="-1" role="dialog" aria-labelledby="rsvpModal"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="height:100%">
                    <!-- rsvp form -->
                                        <rsvp-component :invitation_id="3106" code="#" overlay="1">
                    </rsvp-component>
                                        <!-- rsvp form -->
                ...
                <div class="modal-body text-center justify-content-center align-items-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="https://apps.apple.com/id/app/google-chrome/id535886823" class="btn p-1" target="_BLANK">
                            <img src="client/theme3/images/btn_app_store.png" alt="AppStore" height="40px">
                        </a>
                        <a href="https://play.google.com/store/apps/details?id=com.android.chrome&amp;hl=in&amp;gl=US" class="btn p-1" target="_BLANK">
                            <img src="client/theme3/images/btn_play_store.png" alt="PlayStore" height="40px">
                        </a>
                    </div>
                </div>
    ...
    <!-- start script -->
    <script src="client/theme3/js/app1270.js?v=2022-08-01%2022:53:09"></script>
    <script src="client/theme3/cdn.jsdelivr.net/npm/%40splidejs/splide%40latest/dist/js/splide.min.js"></script>
        <script src="client/theme3/themes/themev21270.js?v=2022-08-30%2022:53:09"></script>
    <script>
...
<!-- Mirrored from satumomen.com/preview/azureish-white by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 15:53:40 GMT -->
</html>